...
public class ColorPickerView extends View{
	...
	private void drawSatValPanel(Canvas canvas){
		...
		if(redrawCache || drawCache == null){
			...
			drawCache = Bitmap.createBitmap((int)rect.width(), (int)rect.height(),
	                Bitmap.Config.ARGB_8888);
			Canvas cacheCanvas = new Canvas(drawCache);
			cacheCanvas.drawRect(0.f, 0.f, rect.width(), rect.height(),
					mSatValPaint);
		}
	...
	public boolean onTrackballEvent(MotionEvent event) {
		...
		if(update){
			...
			if(mListener != null){
				mListener.onColorChanged(Color.HSVToColor(mAlpha, new float[]{mHue, mSat, mVal}), this);
			}
