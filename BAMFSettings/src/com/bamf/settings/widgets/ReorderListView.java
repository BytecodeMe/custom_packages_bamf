...
public class ReorderListView extends ListView {
    private final static String TAG = ReorderListView.class.getSimpleName();
    ...
    public ReorderListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void doExpansion() {
        ...
        for (int i = 0;; i++) {
            ...
            vv.setPadding(vv.getPaddingLeft(), (height - mItemHeightNormal), 
                    vv.getPaddingRight(), vv.getPaddingBottom());
    ...
    private void startDragging(Bitmap bm, int x, int y) {
        ...
        //we want it to be slightly smaller than normal height but the 
        //graphic should extend slightly into the adjacent items on the corners
        mWindowParams.height = mItemHeightNormal; //+ (mItemHeightNormal / 3);
        ...
        v.setBackgroundColor(0xcc0099cc);
        //v.setBackgroundResource(R.drawable.rearrange_frame);
